...
public:
  ...
  static shared_ptr<Symbol> GetChild(shared_ptr<Symbol> symbol, int level0Index,
                                     int ID0) {
  ...
  static shared_ptr<Symbol> GetChild(shared_ptr<Symbol> symbol, int level0Index,
                                     int ID0, int level1Index, int ID1) {
  ...
  static shared_ptr<Symbol> GetChild(shared_ptr<Symbol> rootSymbol,
                                     int level0Index, int ID0, int level1Index,
                                     int ID1, int level2Index, int ID2) {
